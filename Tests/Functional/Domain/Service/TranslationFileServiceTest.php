 ...
 */
class TranslationFileServiceTest extends \TYPO3\CMS\Core\Tests\FunctionalTestCase
{
         ...
         * @var array
         */
        protected $coreExtensionsToLoad = array('extbase', 'fluid', 'backend');
        ...
        public function setUp()
        {
                ...
                $this->translationFileService = $objectManager->get('Lightwerk\L10nTranslator\Domain\Service\TranslationFileService');
        }
